package com.togettech.ajarke.ui.weather;
...
public class WeatherFragment extends Fragment{
    ...
    class weatherTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... args) {
            String CITY = "Yaoundé, CM";
            String API = "43068445440712cdd4efee37e66d1bc0";
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                String updatedAtText = "Mis à jour à: " + new SimpleDateFormat("dd/MM/yyyy hh:mm a", Locale.ENGLISH).format(new Date(updatedAt * 1000));
